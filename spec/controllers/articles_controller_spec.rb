  ...
  describe "GET #edit" do
    ...
    context "owner is allowed to edit his articles" do
      it "renders the edit template" do
        login_user @john
        article = Article.create(title: "first article", body: "body fo first article", user: @john)
    ...
    context "non-owner is not allowed to edit other users articles" do
      it "redirects to the root path" do
        ...
        article = Article.create(title: "First article again", body: "body of first article", user: @john)
